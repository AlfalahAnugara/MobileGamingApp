...
public class CrudRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crud_register);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (resultCode == RESULT_OK) {
                Toast.makeText(CrudRegisterActivity.this, "Login Berhasil", Toast.LENGTH_SHORT).show();
                updateUI();
            }else {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(CrudRegisterActivity.this, "Login Dibatalkan", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        switch (v.getId()){
            ...
            case R.id.save:
                ...
                if(isEmpty(getNIM) || isEmpty(getNama) || isEmpty(getJurusan)){
                    ...
                    Toast.makeText(CrudRegisterActivity.this, "Data tidak boleh ada yang kosong", Toast.LENGTH_SHORT).show();
                }else {
                    /*
                    ...
                    getReference.child("Admin").child(getUserID).child("Mahasiswa").push()
                            ...
                            .addOnSuccessListener(this, new OnSuccessListener() {
                                ...
                                public void onSuccess(Object o) {
                                    ...
                                    Nama.setText("");
                                    Jurusan.setText("");
                                    Toast.makeText(CrudRegisterActivity.this, "Data Tersimpan", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
                break;
                ...
                AuthUI.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                Toast.makeText(CrudRegisterActivity.this, "Logout Berhasil", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        });
                break;
